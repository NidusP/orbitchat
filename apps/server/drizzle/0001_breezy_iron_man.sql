...
CREATE INDEX "comments_post_timeline_idx" ON "comments" USING btree ("post_id","created_at") WHERE "comments"."deleted_at" IS NULL;--> statement-breakpoint
...
CREATE INDEX "posts_author_timeline_idx" ON "posts" USING btree ("author_id","created_at") WHERE "posts"."deleted_at" IS NULL;