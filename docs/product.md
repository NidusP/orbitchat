...
| **文字聊天** | 一对一在线文字聊天、消息推送 | P1 | Phase 3 |
| **群组聊天** | 群聊创建、成员管理、群消息 | P1 | Phase 3 |
| **实时音视频** | 一对一/群组语音视频通话（WebRTC 信令） | P2 | Phase 4 |
| **通知系统** | 关注、评论、点赞、聊天、通话通知 | P1 | Phase 2–3 |
| **AI Chat** | 与 AI 助手对话（个人助手 / 社交场景） | P2 | Phase 4 |
...
不实现数据模型（见 `docs/db-schema.md` 规划）。
...
- [x] 完整的文档体系（含 5 篇 Phase 0 ADR）
- [x] 可运行的后端框架（Bun + Hono）
- [x] 可运行的前端框架（Next.js）
- [x] 共享包结构（shared-types / shared-utils / ui）
- [x] 开发规范与 API spec 框架
