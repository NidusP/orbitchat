...
> **4A 状态：已完成**；**4B 状态：已完成**（FC 写工具 + 井字棋）— 见 [phase-3b-4b-closeout.md](./phase-3b-4b-closeout.md)  
> **4C 状态：待做**；Agent 记忆/RAG 见 [phase-4-agent-memory-rag-plan.md](./phase-4-agent-memory-rag-plan.md)
...
- [ ] 小轨完善（Wave 0–5）— [phase-4-orbit-guide-plan.md](./phase-4-orbit-guide-plan.md)；M1/M2/M3 技术深描见 [phase-4-agent-memory-rag-plan.md](./phase-4-agent-memory-rag-plan.md)
